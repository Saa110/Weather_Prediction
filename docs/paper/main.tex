...
\usepackage{mathptmx}            % Times Roman font (AMS standard)
...
\bibliographystyle{plainnat}      % author-year style (swap to ametsoc for final AMS submission)
...
\texttt{syed.asad@s.amity.edu}
\end{tabular}
&
\begin{tabular}[t]{c}
\textbf{Dr.\ Shalini Agarwal} \\
Amity University Lucknow \\
\texttt{sagarwal@lko.amity.edu}
\end{tabular}
&
\begin{tabular}[t]{c}
\textbf{Syed Mohammad Qasim} \\
Boston University \\
\texttt{smdqsm@gmail.com}
\end{tabular}
\\[1.2em]
\begin{tabular}[t]{c}
\textbf{Akram Tariq Khan} \\
$<$Affiliation$>$ \\
\texttt{akramtariqkhan@gmail.com}
\end{tabular}
&
\begin{tabular}[t]{c}
\textbf{Karnav Shah} \\
$<$Affiliation$>$ \\
\texttt{karnavvshah97@gmail.com}
\end{tabular}
&
\end{tabular}
}
...
\noindent\textbf{Keywords:} model output statistics, machine learning, post-processing,
historical forecasts, reanalysis, ERA5, temperature prediction
...
models and proper evaluation. \mbox{\citet{schulz2022machine}} systematically compared
...
active Kalshi daily temperature markets.}
\label{tab:stations}
\small
\begin{tabular}{llrr}
\toprule
...
artefact of one particular model family (Figure~\ref{fig:data_source}).
...
test (HF $<$ ERA5). Improvement = $(1 - \text{HF}/\text{ERA5}) \times 100$.}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\textwidth]{fig1_data_source_comparison.pdf}
...
$\pm 1$~SE. HF training data yields lower MAE for every architecture.}
...
are against the best architecture (boldface).}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.7\textwidth]{fig2_architecture_comparison.pdf}
\caption{Architecture comparison (3-year, Historical Forecast). Error bars
show $\pm 1$~SE across 28~stations.}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.7\textwidth]{fig3_window_sensitivity_maxt.pdf}
\caption{Training window sensitivity: MaxT. Shaded bands show $\pm 1$~SE
across 28~stations.}
\label{fig:window_maxt}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.7\textwidth]{fig4_window_sensitivity_mint.pdf}
\caption{Training window sensitivity: MinT.}
\label{fig:window_mint}
\end{figure}
...
\begin{table}[ht]
\centering
\caption{Mean MAE (\textdegree{}F) across 28~stations: raw NWP vs.\ best MOS model.}
\label{tab:baseline}
\begin{tabular}{lcccc}
\toprule
...
and skill score (SS = $1 - \text{model}/\text{GFS}$).}
\label{tab:baseline_climate}
\small
...
\begin{subfigure}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\textwidth]{fig5_baseline_comparison.pdf}
  \caption{Raw NWP vs.\ best MOS model.}
  \label{fig:baseline_bars}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\textwidth]{fig5b_skill_score_by_climate.pdf}
  \caption{Skill score by climate type.}
  \label{fig:skill_climate}
\end{subfigure}
\caption{(a)~Mean MAE: raw NWP baselines vs.\ best MOS model (28~stations).
(b)~MOS skill score relative to raw GFS by climate type.}
\label{fig:baseline}
\end{figure}
...
\begin{table}[ht]
\centering
\caption{Top 10 features by mean importance (\%) across architectures.}
\label{tab:features}
\small
...
\begin{subfigure}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\textwidth]{fig6_feature_importance_maxt.pdf}
  \caption{MaxT feature importance.}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\textwidth]{fig7_feature_importance_mint.pdf}
  \caption{MinT feature importance.}
\end{subfigure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.95\textwidth]{fig9_ablation_delta_mae.pdf}
...
Table~\ref{tab:seasonal} and Figure~\ref{fig:seasonal} present MAE by season for
...
28~stations). SE computed across station-days.}
\label{tab:seasonal}
\begin{tabular}{lcccccc}
\toprule
& \multicolumn{3}{c}{MaxT} & \multicolumn{3}{c}{MinT} \\
...
\begin{subfigure}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\textwidth]{fig10_seasonal_mae.pdf}
  \caption{Seasonal MAE.}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\textwidth]{fig10b_monthly_mae.pdf}
  \caption{Monthly MAE.}
\end{subfigure}
\caption{Seasonal and monthly MAE breakdown (Linear, 3-year HF, 28~stations).
Error bars / shaded bands show $\pm 1$~SE.}
\label{fig:seasonal}
\end{figure}
...
\input{tables/table_supp_rmse.tex}
